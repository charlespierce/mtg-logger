...
export class Initial1535007367470 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_match" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "notes" text, "match_date" date, "opponent" text COLLATE NOCASE, "opponent_archetype" text COLLATE NOCASE, "sessionId" integer, CONSTRAINT "FK_3ea343f1fc35553e9c2c8770c04" FOREIGN KEY ("sessionId") REFERENCES "session" ("id") ON DELETE CASCADE)`);
