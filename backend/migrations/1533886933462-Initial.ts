...
export class Initial1533886933462 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "session" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" text NOT NULL, "session_date" datetime, "archetypeId" integer, "formatName" text COLLATE NOCASE)`);
        await queryRunner.query(`CREATE TABLE "match" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "notes" text, "match_date" date, "opponentId" integer, "opponentArchetypeId" integer, "sessionId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_match" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "notes" text, "match_date" date, "opponentId" integer, "opponentArchetypeId" integer, "sessionId" integer, CONSTRAINT "FK_7efcae0561c2d0bceb0b0eeff39" FOREIGN KEY ("opponentId") REFERENCES "opponent" ("id"), CONSTRAINT "FK_094267dff96378e378a23565140" FOREIGN KEY ("opponentArchetypeId") REFERENCES "archetype" ("id"), CONSTRAINT "FK_3ea343f1fc35553e9c2c8770c04" FOREIGN KEY ("sessionId") REFERENCES "session" ("id"))`);
        await queryRunner.query(`INSERT INTO "temporary_match"("id", "notes", "match_date", "opponentId", "opponentArchetypeId", "sessionId") SELECT "id", "notes", "match_date", "opponentId", "opponentArchetypeId", "sessionId" FROM "match"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "match" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "notes" text, "match_date" date, "opponentId" integer, "opponentArchetypeId" integer, "sessionId" integer)`);
        await queryRunner.query(`INSERT INTO "match"("id", "notes", "match_date", "opponentId", "opponentArchetypeId", "sessionId") SELECT "id", "notes", "match_date", "opponentId", "opponentArchetypeId", "sessionId" FROM "temporary_match"`);
